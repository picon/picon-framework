...
use picon\test\core\cache\serializables\ExternalNamespaceClass;

use picon\core\cache\PiconSerializer;
use picon\core\utils\SerializableClosure;
use picon\test\core\cache\serializables\PiconClass;
...
class SerializableClosureTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $piconClass = new PiconClass();
        $closure = function(picon\test\core\cache\serializables\PiconClass $typeHintedValue)
        {
            return $typeHintedValue;
        };
