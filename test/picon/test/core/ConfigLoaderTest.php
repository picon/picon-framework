...
class ConfigLoaderTest extends AbstractPiconUnitTest
{
    public function testValidConfig()
    {
        $config = ConfigLoader::load(__DIR__.'/../../../config/picon.xml');
        $this->assertSame('HomePage', $config->getHomePage());
        $this->assertSame('auto', $config->getStartUp());
        
        $config = ConfigLoader::load(__DIR__.'/../../../config/full.xml');
        $this->assertSame('HomePage', $config->getHomePage());
        $this->assertSame('auto', $config->getStartUp());
    ...
    {
        ConfigLoader::load(dirname(__FILE__).'/badconfig.xml');
    }
    ...
    {
        ConfigLoader::load(dirname(__FILE__).'/missingprofile.xml');
    }
}
